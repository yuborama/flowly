...
export default function SettingsScreen() {
  ...
  const handleReset = () => {
    Alert.alert('Resetear datos', 'Se borraran usuario, amigos y tareas locales.', [
    ...
    <ScrollView style={styles.screen} contentContainerStyle={styles.container}>
      ...
      <View style={styles.profileCard}>
        <View style={styles.avatar}>
          <Text style={styles.avatarLabel}>{user?.name.slice(0, 1).toUpperCase() ?? 'A'}</Text>
      ...
      <View style={styles.sectionCard}>
        <SettingRow icon="sync-outline" title="Sync Settings" value="Auto-sync ON" />
        <View style={styles.rowDivider} />
        <SettingRow icon="color-palette-outline" title="App Theme" value="Dark Mode" />
      </View>
