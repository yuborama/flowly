    ...
    <ScrollView style={styles.screen} contentContainerStyle={styles.container}>
      ...
      <View style={styles.addCard}>
        ...
        <Pressable
          ...
          <Text style={styles.addButtonLabel}>{isSaving ? 'Adding...' : 'Add Friend'}</Text>
        </Pressable>
      </View>
      ...
      <View style={styles.listWrap}>
          ...
          <View key={friend.id} style={styles.friendCard}>
            <View style={styles.friendLeft}>
              <View style={styles.avatar}>
                <Text style={styles.avatarLabel}>{friend.name.slice(0, 1).toUpperCase()}</Text>
              </View>
              <View>
        ...
        {friends.length === 0 ? (
          <Text style={styles.emptyText}>No friends yet. Add your first collaborator above.</Text>
        ) : null}
      </View>
    </ScrollView>
  );
